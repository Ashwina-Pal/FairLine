...
class Claim(BaseModel):
    ...
    receipt_image_url: str | None = Field(None, description="URL to the uploaded receipt image in Storage")
    extracted_data: ExtractedData | None = Field(None, description="Structured data extracted by the agent")
    evidence_packet: EvidencePacket | None = Field(None, description="Policy violations flagged by the skill")
...
class AuditLog(BaseModel):
    ...
    details: str | None = Field(None, description="Stringified JSON payload with extra details")
