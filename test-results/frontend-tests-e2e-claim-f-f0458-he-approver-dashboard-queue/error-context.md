...
- Name: frontend\tests\e2e\claim-flow.spec.ts >> Fairline Claim Triage Flow >> should list escalated claims in the approver dashboard queue
- Location: frontend\tests\e2e\claim-flow.spec.ts:85:7
...
Call log:
  - navigating to "/approver", waiting until "load"
