...
- Name: frontend\tests\e2e\claim-flow.spec.ts >> Fairline Claim Triage Flow >> should auto-approve a clean claim under $50
- Location: frontend\tests\e2e\claim-flow.spec.ts:5:7
